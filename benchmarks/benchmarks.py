...
from benchmarks import make_data
...
def run_benchmark(files, rnaseq_setup, ppi_setup, cutoff_setup, analysis_setup, benchmark_setup,
    ...
    rnaseq_data_ = read_data.load_rnaseq(rnaseq_file=files['rnaseq'],
