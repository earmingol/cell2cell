...
| - [Step-by-step Pipeline](https://github.com/earmingol/cell2cell/blob/master/examples/cell2cell/Toy-Example.ipynb)<br>- [Interaction Pipeline for Bulk Data](https://cell2cell.readthedocs.io/en/latest/tutorials/Toy-Example-BulkPipeline/)<br>- [Interaction Pipeline for Single-Cell Data](https://cell2cell.readthedocs.io/en/latest/tutorials/Toy-Example-SingleCellPipeline/)<br>- [Whole Body of *C. elegans*](https://github.com/LewisLabUCSD/Celegans-cell2cell)<br>- [Identifying a **spatial code** of ligand-receptor pairs (Genetic Algorithm)](https://cell2cell.readthedocs.io/en/latest/tutorials/Genetic-Algorithm-LR-Selection/)<br>&nbsp;&nbsp;&nbsp;&nbsp;- [Reproducing the *C. elegans* spatial code](https://cell2cell.readthedocs.io/en/latest/tutorials/Celegans-Spatial-Code/)<br>&nbsp;&nbsp;&nbsp;&nbsp;- [Customizing the objective function](https://cell2cell.readthedocs.io/en/latest/tutorials/Custom-Objective-Functions/)<br>&nbsp;&nbsp;&nbsp;&nbsp;- [A spatial code across samples](https://cell2cell.readthedocs.io/en/latest/tutorials/Spatial-Code-Across-Samples/) | - [Obtaining patterns of cell-cell communication](https://cell2cell.readthedocs.io/en/latest/tutorials/ASD/01-Tensor-Factorization-ASD/)<br>- [Downstream 1: Factor-specific analyses](https://cell2cell.readthedocs.io/en/latest/tutorials/ASD/02-Factor-Specific-ASD/)<br>- [Downstream 2: Patterns to functions (GSEA)](https://cell2cell.readthedocs.io/en/latest/tutorials/ASD/03-GSEA-ASD/)<br>- [Tensor-cell2cell in Google Colab (**GPU**)](https://colab.research.google.com/drive/1T6MUoxafTHYhjvenDbEtQoveIlHT2U6_?usp=sharing)<br>- [Communication patterns in **Spatial Transcriptomics**](https://cell2cell.readthedocs.io/en/latest/tutorials/Tensor-cell2cell-Spatial/) <br>- [Multi-modal communication patterns with **Coupled Tensor Component Analysis**](https://cell2cell.readthedocs.io/en/latest/tutorials/Version2/Tensor-cell2cell-CTCA/) |
...
- **Tensor-cell2cell v2**: [Tensor-cell2cell v2 unravels coordinated dynamics of protein- and metabolite-mediated cell-cell communication](https://doi.org/10.1093/bioinformatics/btaf667).
  *Bioinformatics, 2026.*
